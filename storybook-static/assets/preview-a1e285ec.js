import{s}from"./index-d475d2ea.js";var i="storybook/highlight",n="storybookHighlight",_=`${i}/add`,g=`${i}/reset`;const{addons:m}=__STORYBOOK_MODULE_PREVIEW_API__,{STORY_CHANGED:E}=__STORYBOOK_MODULE_CORE_EVENTS__;var{document:l}=s,H=(e="#FF4785",t="dashed")=>`
  outline: 2px ${t} ${e};
  outline-offset: 2px;
